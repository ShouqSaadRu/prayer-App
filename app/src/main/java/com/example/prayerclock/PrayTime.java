...
public class PrayTime {
    ...
    private int timeFormat; // tim  e format
    ...
    // Time Names
    private ArrayList<String> timeNames;//An array containing names of the prayers (Fajr, Sunrise, Dhuhr, Asr, Sunset, Maghrib, Isha).
    ...
    private HashMap<Integer, double[]> methodParams; //A HashMap containing calculation parameters for different juristic methods.
    ...
    /*calcMethod: The currently selected calculation method (Jafari, Karachi, etc.).
lat: Latitude of the location.
lng: Longitude of the location.
timeZone: Time zone offset of the location.
JDate: Julian date for the calculation.*/
    ...
    public PrayTime() {
        ...
        // Time Formats
        this.setTime24(1); // 24-hour format //acutually me shouq, i putted 1 which is 12-hours cuz the this.setTime12(1) is not working
        this.setTime12(0); // 12-hour format
    ...
    public ArrayList<String> getPrayerTimes(Calendar date, double latitude,
                                             double longitude, double tZone) {  //getPrayerTimes: This function takes the date, location (latitude, longitude, timezone), and calculates prayer times for that day.
    ...
    public ArrayList<String> getPrayerNames(Calendar date, double latitude,
                                            double longitude, double tZone) {  //getPrayerTimes: This function takes the date, location (latitude, longitude, timezone), and calculates prayer times for that day.
    ...
    public String floatToTime24(double time) { //floatToTime24, floatToTime12, floatToTime12NS: These functions convert floating-point time values to different time formats (24-hour, 12-hour with/without suffix).
    ...
    /*sunPosition: Calculates the declination angle of the sun and equation of time.
equationOfTime: Calculates the equation of time (difference between solar time and mean time).
sunDeclination: Calculates the declination angle of the sun.
computeMidDay: Calculates the Dhuhr (midday) prayer time.
computeTime: Calculates the time for a given prayer angle (Fajr, Maghrib, Isha).
computeAsr: Calculates the Asr prayer time based on the selected juristic method (Shafii or Hanafi).*/
    ...
    public static void main(String[] args) {
        ...
        prayers.setCalcMethod(prayers.Shafii);
